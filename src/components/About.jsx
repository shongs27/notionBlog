    ...
    <>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.contentIntroduce}>
            ...
            <ul>
              ...
              <li>무엇보다도 꾸준함의 가치를 믿고 학습하며 기술 노션페이지를 기록하고 있습니다</li>
      ...
      <div className={styles.category}>
        ...
        <div className={styles.container}>
          ...
          <p>
            지속적인 블로그 관리를 위해 TDD를 적용합니다 리팩토링을 통해 더 나은 UI와 학습한 글을 정리해서 쉽게
            서술함으로서 다시 한번 학습하고 오픈소스에 기여함을 목적으로 합니다
          </p>
        </div>
      </div>
      ...
      <div className={styles.category}>
        ...
        <div className={styles.container}>
          ...
          <p>
            리팩토링을 통한 코드 개선과 서로 소통할 수 있는 코드의 중요성을 배운 소중한 경험이었습니다. 리액트의
            기본적인 원리를 바탕으로 작은 프로젝트들을 거듭하며 TDD 개발 방법을 익혔습니다. 무엇보다 나만이 이해하는
            코드가 아닌 쉽고, 편하고, 명확하게 이해할 수 있는 코드에 대해서 고민하는 계기였습니다.
          </p>
        </div>
        ...
        <div className={styles.container}>
          ...
          <p>인텔에서 주관하는 인공지능 관련 교육과 드론을 이용한 자동주행 실습</p>
          <ul>
            <li>1개월 교육</li>
          </ul>
        </div>
        ...
        <div className={styles.container}>
          ...
          <p>
            협업과 도메인지식의 중요성에 대해 깨닫고 프로그래밍 프로젝트를 전체적으로 관망할 수 있는 강력한 첫
            경험이었습니다. 프로젝트 초반, 팀원과의 부족했던 소통으로 인해 머신러닝의 학습모델에 적용이 되지 않는 정제
            과정이 필요 없는 변수를 가공하며 많은 시간을 소모하게 되었는데요, 그 후 프로젝트를 리빌딩하면서 서로의
            업무에 대한 관심과 대화를 통한 협동의 중요성을 확인하고 개선시켜 빠르게 시간을 절약해 나갔고 협동을 통해
            학습모델을 위한 적절한 변수를 선정하여 예측율을 70퍼센트까지 끌어올릴 수 있었습니다. 협업과 서로를 위한
            피드백이 중요하다는 것을 깨닫는 경험이었습니다.
          </p>
        </div>
      </div>
